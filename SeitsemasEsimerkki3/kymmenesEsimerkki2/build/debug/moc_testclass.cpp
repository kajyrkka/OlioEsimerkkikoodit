...
QT_MOC_LITERAL(1, 10, 12), // "msgToThread1"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "finishProgram"
QT_MOC_LITERAL(4, 38, 10), // "testSignal"
QT_MOC_LITERAL(5, 49, 11) // "msgReceived"

    },
    "testClass\0msgToThread1\0\0finishProgram\0"
    "testSignal\0msgReceived"
};
...
void testClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->msgToThread1((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->finishProgram(); break;
        case 2: _t->testSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->msgReceived((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&testClass::msgToThread1)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&testClass::finishProgram)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void testClass::msgToThread1(QString _t1)
{
