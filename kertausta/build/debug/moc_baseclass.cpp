...
QT_MOC_LITERAL(1, 10, 17), // "passwordSetSignal"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "BaseClass\0passwordSetSignal\0"
};
...
void BaseClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->passwordSetSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BaseClass::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseClass::passwordSetSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BaseClass::passwordSetSignal(QString _t1)
{
